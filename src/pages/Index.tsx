import heroBanner from "@/assets/hero-oficial-2-1.png";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        <section aria-label={t("home_hero_aria")} className="relative w-full overflow-hidden bg-mel-banner3">
        ...
        <section aria-label={t("home_study_desktop_aria")} className="hidden bg-mel-blue-800 md:block">
            ...
            <div className="grid grid-cols-2 items-stretch gap-6">
              <div className="flex h-full flex-col items-center text-center">
                ...
                <div className="mt-auto flex justify-center pt-4">
                  <a
                    className="inline-flex h-11 w-full max-w-[420px] items-center justify-center bg-mel-blue-700 px-6 font-display text-[10px] font-semibold uppercase tracking-[0.28em] text-primary-foreground"
        ...
        <section aria-label={t("home_study_mobile_aria")} id="estudo" className="relative w-full overflow-hidden bg-mel-blue-800 md:hidden">
          <div aria-hidden className="absolute inset-0 bg-gradient-to-b from-transparent to-mel-overlay/20" />
          <div className="relative">
            <div className="bg-gradient-to-b from-mel-blue-600 to-mel-blue-800 px-[20px] py-[18px]">
              ...
              <div className="mt-4 flex justify-center">
                <a
                  className="inline-flex h-11 w-full items-center justify-center bg-mel-blue-700 px-6 font-display text-[10px] font-semibold uppercase tracking-[0.28em] text-primary-foreground"
                  href="https://missionevangeliquelusitana.com/reunioes-pelo-zoom/"
                >
                  {t("home_estudo_btn")}
                </a>
        ...
        <section aria-label="Cultos e células" className="bg-gradient-to-br from-mel-blueA to-mel-blueB p-px">
          <div className="grid w-full items-stretch md:grid-cols-2">
            <div className="relative overflow-hidden bg-mel-banner3">
              <div aria-hidden className="absolute inset-0 z-0 bg-gradient-to-br from-mel-banner2/60 via-mel-banner3/85 to-mel-banner1/60" />
              <PhotoOverlay />
            ...
            <div className="relative overflow-hidden bg-mel-banner3" id="celulas">
              <div aria-hidden className="absolute inset-0 z-0 bg-gradient-to-br from-mel-banner2/60 via-mel-banner3/85 to-mel-banner1/60" />
              <PhotoOverlay />
              <div className="relative z-30 flex min-h-[220px] flex-col items-center justify-center gap-4 px-6 text-center sm:min-h-[240px] md:min-h-[280px] md:px-8">
                <h2 className="font-display text-[24px] font-semibold uppercase tracking-[0.11em] text-mel-ice drop-shadow-md animate-fade-in md:text-[26px]">
        ...
        <section id="pastoral" aria-label="Família pastoral" className="bg-card p-px">
          <div className="container py-10 text-center">
            <h2 className="font-display text-[2.2em] text-mel-blue-800">{t("home_familia_pastoral")}</h2>
            <div className="mt-6">
              <PastorsCarousel />
            </div>
            <img
